...
EX vector<orbinfo> orbinfos = {
  ...
  {orbgenflags::S_NATIVE, laRlyeh,          2500, 1500, itOrbShield},
  {orbgenflags::S_GUEST,  laDesert,         2500, 0,    itOrbShield},
  {orbgenflags::S_YENDOR, laHell,           2000, 1000, itOrbYendor},
  {orbgenflags::S_NATIVE, laEndorian,       1500, 1500, itOrbTeleport},
  {orbgenflags::S_GUEST,  laRlyeh,          1500, 0,    itOrbTeleport},
  {orbgenflags::S_NA_O25, laMotion,         2000, 700,  itOrbSafety},    
  {orbgenflags::S_GUEST,  laIce,            1500, 0,    itOrbWinter},
//  {orbgenflags::S_GUEST,  laDragon,         2500, 0,    itOrbWinter}, // No longer required, Orb of Fire is better
  {orbgenflags::S_GUEST,  laDryForest,      2500, 0,    itOrbWinter}, 
  {orbgenflags::S_NATIVE, laBrownian,       1500, 1500, itOrbMorph},
  {orbgenflags::S_GUEST,  laCocytus,        1500, 0,    itOrbMorph},
//  {orbgenflags::S_GUEST,  laCocytus,        1500, 0,    itOrbWinter}, // Is now the native orb
  ...
  {orbgenflags::S_NATIVE, laElementalWall,  900,  1200, itOrbAether},
  {orbgenflags::S_GUEST,  laWineyard,       900,  0,    itOrbAether},
  {orbgenflags::S_NATIVE, laHive,           800,  1200, itOrbInvis},
  {orbgenflags::S_NATIVE, laDragon,         2000, 3000, itOrbFire},
  {orbgenflags::S_NATIVE, laMinefield,      0,    3500, itOrbFriend},
  {orbgenflags::S_NATIVE, laBlizzard,       0,    3000, itOrbDragon},
  {orbgenflags::S_GUEST,  laTemple,         3000, 0,    itOrbDragon}, // Temple has special spawning rules
  {orbgenflags::S_NATIVE, laCamelot,        1000, 3500, itOrbTime}, // Double check to make sure it spawns
  {orbgenflags::S_GUEST,  laCaribbean,      3500, 0,    itOrbTime},
  {orbgenflags::S_NATIVE, laSwitch,         1800, 2500, itOrbSpace},
  {orbgenflags::S_GUEST,  laRedRock,        2500, 0,    itOrbSpace},
  {orbgenflags::S_NATIVE, laPalace,         1000, 1500, itOrbIllusion},
  {orbgenflags::S_GUEST,  laCamelot,        1000, 0,    itOrbIllusion},
  {orbgenflags::S_NATIVE, laPower,          0,    1500, itOrbEmpathy}, // Land of Power has special spawning rules
//  {orbgenflags::S_GUEST,  laOcean,          1500, 0,    itOrbEmpathy},
  {orbgenflags::S_GUEST,  laOcean,          0,    0,    itOrbAir},
  {orbgenflags::S_NATIVE, laCaribbean,      3000, 4000, itOrbDiscord},
  {orbgenflags::S_GUEST,  laPalace,         0,    0,    itOrbDiscord}, // Palace has special spawning rules
  ...
  {orbgenflags::S_NAT_NT, laRedRock,        1500, 4000, itOrbSummon},
  {orbgenflags::S_GUEST,  laElementalWall,  1500, 0,    itOrbSummon},
  {orbgenflags::S_NATIVE, laStorms,         1000, 2500, itOrbStunning},
  {orbgenflags::S_NAT_NT, laOcean,          1000, 800,  itOrbLuck}, // Coast has special spawning rules
  ...
  {orbgenflags::S_NATIVE, laDesert,         500,  5000, itOrbDomination},
  {orbgenflags::S_GUEST,  laDragon,         500,  5000, itOrbDomination},
  {orbgenflags::S_NATIVE, laTortoise,       2500, 1500, itOrbShell},
  {orbgenflags::S_NATIVE, laTemple,         150,  2500, itOrbEnergy},
  {orbgenflags::S_GUEST,  laEndorian,       150,  0,    itOrbEnergy},
//  {orbgenflags::S_GUEST,  laEndorian,       450,  0,    itOrbTeleport}, // Is now the active orb
  ...
  {orbgenflags::S_NATIVE, laCocytus,        2000, 2000, itOrbWinter},
  {orbgenflags::S_GUEST,  laBlizzard,       2000, 0,    itOrbWinter},
...
//  {orbgenflags::S_GUEST,  laSwitch,         2000, 0,    itOrbSpace}, // Is now the active orb
  {orbgenflags::S_NATIVE, laOvergrown,      2000, 3000, itOrbPhasing},
//  {orbgenflags::S_GUEST,  laSwitch,         2000, 0, itOrbPhasing},
  ...
  {orbgenflags::S_NATIVE, laEclectic,       900,  4200, itOrbChoice},
  {orbgenflags::S_GUEST,  laBrownian,       900,  0,    itOrbChoice},
...
//  {orbgenflags::S_NATIVE, laEclectic,       1000, 1000, itOrbChaos}, // Orb of Chaos was mostly just annoying, and has been removed
  ...
  {orbgenflags::S_GUEST,  laWet,            1200, 0,    itOrbStone},
  {orbgenflags::S_NATIVE, laWineyard,       900,  1200, itOrbDisintegration}, // new!
...
EX eOrbLandRelation getOLR(eItem it, eLand l) {
  ...
  if(l == laPower) {
    if(it == itOrbEmpathy) return olrPNative;

    if(
      it == itOrbFlash || it == itOrbSpeed || it == itOrbFire || it == itOrbAether ||
...
//  if(it == itOrbDigging && l == laKraken) return olrUseless;
  ...
  if(it == itOrbTime) return olrPrize3;
  ...
  if(it == itOrbDisintegration && !among(l, 
    laAlchemist, laCamelot, laClearing,
    laCocytus, laDragon, laEndorian, laHell, laHive, laHunting, laJungle, laMinefield, laMirror,
    laMotion, laPrairie, laReptile, laVolcano, laWestWall))
    return olrUseless;

  if(it == itOrbDisintegration && (l == laPrincessQuest || l == laPalace))
    return olrForbidden;
